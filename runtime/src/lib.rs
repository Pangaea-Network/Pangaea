...
use primitives::{AccountId, AccountIndex, Balance, BlockNumber, DigestItem, Hash, Index, Signature,};
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Treasury: pallet_treasury::{Module, Call, Storage, Event<T>, Config<T>},
